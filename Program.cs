...
namespace SnakeGame
{
    class Game
    {
        ...
        static void Loop(object obj)
        {
            ...
            {
                foodFactory.CreateFood();
                PeriodTime -= 5; // время на которое уменьшается время, следовательно увеличивается скорость, после еды 
                PeriodTime = Math.Clamp(PeriodTime, 50, 100); // меньше 50 тайимер не опустится 
